...
$secondSelection.fadeOut(1000);
 ...
 function finalOutput(){
    ...
    {swal({
        ...
        imageSize: '70x70',
        title: 'احسنت!',
        text: 'لقد صنعت الآيس كريم الذي يرغب به الدب',
        button: "مرحى",
      }
...
$colorNeeded.text('التقط اللون الأحمر، الأصفر، الأزرق والبني');
$colorNeeded.css({
    'font-family': "'Arima Madurai', cursive",
	'color':'#009688',
	'text-align': 'center'
            ...
            function ops(){
                $(this).addClass('ops');
                  ...
                  swal({
                    icon: 'error' ,
                    title: 'اوه لا!',
                    text: 'لقد خسرت جميع المحاولات لمساعدة ليلى',
                    button: "سأحاول مره اخرى",
                  })
...
function correctY(){
 ...
 $( ".bearGame" ).hover(
    function() {
      $( this ).append( $( "<span> تساعد هذه اللعبة في تعليم الطفل كيفية إجراء اتصال أفضل بالعين. .</span>" ) );
    }, function() {
  ...
  $( ".paintingGame" ).hover(
    function() {
      $( this ).append( $( "<span> تساعد هذه اللعبه على التركيز على الأشياء المتحركة وفهم الألوان بشكل أكثر.</span>" ) );
    }, function() {
      $( this ).find( "span:last" ).remove();
    }
  );
...
$( ".emotionsGame" ).hover(
    function() {
      $( this ).append( $( "<span> تساعد هذه اللعبه في جعل الطفل يفهم مشاعر الآخرين بشكل أفضل من خلال اختيار التعبير الصحيح في كل مره.</span>" ) );
    }, function() {
      $( this ).find( "span:last" ).remove();
    }
  );
